...
public class MyGLRenderer implements GLSurfaceView.Renderer {
    ...
    private static final int NUM_TEX_COMPONENT = 2;

    private static final int STRIDE = (NUM_POSITION_COMPONENT + NUM_TEX_COMPONENT)*BYTES_PER_FLOAT;
    ...
    private static final String A_TEX = "a_Tex";
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
       ...
       // aColorLocation = glGetAttribLocation(program, A_COLOR);
        ...
        aTexLocation = glGetAttribLocation(program, A_TEX);
        ...
        glVertexAttribPointer(aTexLocation, NUM_TEX_COMPONENT, GL_FLOAT, false, STRIDE, vertexData);
    ...
    public void onDrawFrame(GL10 gl) {
      ...
      //  glUniformMatrix4fv(uModelLocation, 1, false, modelMatrix, 0);
       ...
       // glUniform4f(uColorLocation, 1.0f, 0f, 0f, 1f);
        ...
        final int textureId = TextureUtil.loadTexture(mContext, R.drawable.floor);
