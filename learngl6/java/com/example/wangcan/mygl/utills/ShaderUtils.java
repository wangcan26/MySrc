package com.example.wangcan.mygl.utills;
/**
...
public class ShaderUtils {
    ...
    public static int buildProgram(String vertexShaderCode, String fragShaderCode)
    {
        int program;

        int vertexShader = compileVertexShader(vertexShaderCode);
        int fragShader = compileFragShader(fragShaderCode);
